...
protected:
	...
	void Reparar() PURE_VIRTUAL(ANaveEnemiga::Reparar, );
	void cargarCombustible() PURE_VIRTUAL(ANaveEnemiga::cargarCombustible, );
	void pasarEnergia() PURE_VIRTUAL(ANaveEnemiga::pasarEnergia, );
	void pasarArmamento() PURE_VIRTUAL(ANaveEnemiga::pasarArmamento, );
	void Bloqueo() PURE_VIRTUAL(ANaveEnemiga::Bloqueo, );
	void Sabotaje() PURE_VIRTUAL(ANaveEnemiga::Sabotaje, );
	void Espionaje() PURE_VIRTUAL(ANaveEnemiga::Espionaje, );
	void Vigilancia() PURE_VIRTUAL(ANaveEnemiga::Vigilancia, );
	void Apoyo() PURE_VIRTUAL(ANaveEnemiga::Apoyo, );
	void Intercepcion() PURE_VIRTUAL(ANaveEnemiga::Intercepcion, );
	void Comunicacion() PURE_VIRTUAL(ANaveEnemiga::Comunicacion, );
};
